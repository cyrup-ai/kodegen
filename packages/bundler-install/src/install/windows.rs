...
use windows::Win32::System::Registry::{
    HKEY, HKEY_LOCAL_MACHINE, KEY_WRITE, REG_DWORD, REG_EXPAND_SZ, REG_MULTI_SZ, REG_SZ,
...
use windows::Win32::System::Services::{
    ...
    SC_ACTION, SC_ACTION_RESTART, SC_ACTION_TYPE, SC_HANDLE, SC_MANAGER_ALL_ACCESS,
    ...
    SERVICE_CONFIG_DESCRIPTION_W, SERVICE_CONFIG_FAILURE_ACTIONS,
    SERVICE_CONFIG_FAILURE_ACTIONS_FLAG, SERVICE_CONFIG_FAILURE_ACTIONSW,
    SERVICE_CONFIG_SERVICE_SID_INFO, SERVICE_CONTROL_MANAGER_ACCESS_RIGHTS,
...
use windows::Win32::UI::Shell::{SW_HIDE, ShellExecuteW};
