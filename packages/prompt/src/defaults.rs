...
pub const DEFAULT_PROMPTS: &[(&str, &str)] = &[
    ("onb_001", include_str!("../../../data/default_prompts/onb_001.j2.md")),
    ("code_001", include_str!("../../../data/default_prompts/code_001.j2.md")),
    ("refactor_example", include_str!("../../../data/default_prompts/refactor_example.j2.md")),
    ("env_demo", include_str!("../../../data/default_prompts/env_demo.j2.md")),
];
