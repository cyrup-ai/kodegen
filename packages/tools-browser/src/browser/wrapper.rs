...
impl BrowserWrapper {
    ...
    /// Set the current page, closing the previous one if it exists
...
/// browser event handler task. The handler must be aborted when closing the
/// browser to prevent zombie processes.
///
