//! Web search functionality test (Direct SDK - No MCP)
//!
//! Tests the DuckDuckGo-based `web_search` module with proper terminal output.
//! This is an exact copy of citescrape's pattern to verify browser package works identically.
//!
//! Usage:
//!   cargo run --package kodegen_tools_browser --example test_web_search_direct

use kodegen_tools_browser::web_search::{self, BrowserManager};
use std::io::Write;
