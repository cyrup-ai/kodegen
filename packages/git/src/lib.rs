//! kodgen_git - A Git facade over the gix (Gitoxide) library
//!
...
pub use operations::{
    add, branch, checkout, clone_repo, commit, delete_branch, discover_repo, fetch,
    init_bare_repo, init_repo, is_repository, list_branches, list_worktrees, log, merge,
    open_repo, probe_repository, rename_branch, worktree_add, worktree_lock, worktree_prune,
    worktree_remove, worktree_unlock, AddOpts, BranchOpts, CheckoutOpts, CloneOpts, CommitOpts,
    FetchOpts, LogOpts, MergeOpts, MergeOutcome, RepositoryInfo, Signature, WorktreeAddOpts,
    WorktreeInfo, WorktreeLockOpts, WorktreeRemoveOpts,
};
...
/// for compatibility with existing code that expects `kodgen_git::git::*` paths.
pub mod git {
