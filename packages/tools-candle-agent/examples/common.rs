//! Shared utilities for candle-agent SSE server examples
//!
//! This module spawns the local kodegen-candle-agent SSE server and connects to it.
...
/// Candle-agent SSE server configuration
const SSE_PORT: u16 = 30452;
const BINARY_NAME: &str = "kodegen-candle-agent";
const PACKAGE_NAME: &str = "kodegen_candle_agent";

/// SSE server URL for candle-agent examples
const SSE_URL: &str = "http://127.0.0.1:30452/sse";
...
/// Connect to local candle-agent SSE server
