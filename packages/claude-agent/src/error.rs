...
impl From<ClaudeError> for kodegen_tool::error::McpError {
    fn from(err: ClaudeError) -> Self {
        ...
        match err {
            ...
            ClaudeError::PromptTemplateError { template, message } => McpError::Other(anyhow::anyhow!("Template '{}' error: {}", template, message)),
        }
    }
}
