...
/// Validate JSON-RPC error object structure (helper for response validation)
#[allow(dead_code)]
...
/// Check if error code is within valid JSON-RPC ranges (helper for error validation)
#[allow(dead_code)]
fn is_valid_error_code(code: i64) -> bool {
    match code {
        // Standard JSON-RPC errors
        -32700..=-32600 => true, // Parse error to Invalid request
        -32099..=-32001 => true, // Server error range (excluding -32000)
...
#[allow(dead_code)] // Helper function for validation API
