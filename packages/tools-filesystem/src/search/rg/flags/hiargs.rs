...
pub(crate) struct HiArgs {
    ...
    search_zip: bool,
    // sort: Option<SortMode>, // REMOVED: Dead ripgrep code - real sorting uses sorting.rs
...
impl HiArgs {
    ...
    pub(crate) fn from_low_args(mut low: LowArgs) -> anyhow::Result<HiArgs> {
        ...
        Ok(HiArgs {
            ...
            // sort: low.sort, // REMOVED: Dead ripgrep code
            stats,
...
mod binary_mode_tests {
    use super::*;
    use crate::search::rg::flags::lowargs::{BinaryMode as RgBinaryMode, LowArgs};
