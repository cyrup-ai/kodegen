...
const HISTORY_FILENAME: &str = "tool-history.jsonl";
...
pub async fn init_global_history() -> &'static ToolHistory {
    TOOL_HISTORY.get_or_init(|| async { ToolHistory::new().await }).await
}
